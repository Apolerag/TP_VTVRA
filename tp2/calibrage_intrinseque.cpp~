...
int main(int argc, char *argv[])
{
	...
	while( goOn && ! intCal_block4->getDone())
	{
		...
		printMat( &block4_out1, "default", "stdout", "/Students/p0908892/TP_openCV/tp2/intrinsic.txt");
		printMat( &block4_out2, "default", "stdout", "/Students/p0908892/TP_openCV/tp2/distortion.txt");
		printMat( &block4_out3, "default", "stdout", "/Students/p0908892/TP_openCV/tp2/error.txt");
